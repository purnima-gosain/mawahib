...
// class CartStepProgressBar extends StatelessWidget {
//   // final List<String> stepperList = ['Cart', 'Shipping', 'Payment', 'Summary'];
//   final List<String> stepperList = ['Cart', 'Checkout'];
...
//   /// A step that displays a pencil icons in its circle.
//   editing,

//   /// A step that displays a tick icons in its circle.
//   complete,
